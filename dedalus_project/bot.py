...
from classes import AddressBook, Name, Phone, Birthday, Email, Record, ConsoleInterface
...
def main():
    ...
    ui.display_message(f"/// \U0001F916 {bot_ver} loaded. Waiting for command. \"help\" to show list of all commands.")
    ...
    while True:
        ...
        if cmd == unknown_handler:
            ui.display_message(f"/// Invalid command. Did you mean '{find_closest_command(user_input)}'?")
            continue
